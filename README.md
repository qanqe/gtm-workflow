...
This project was built entirely using natural language instructions inside **Claude Code** — Anthropic's AI-powered terminal for software development.

No boilerplate was written by hand. The lead data, scoring logic, personalization engine, and pipeline orchestration were all generated by describing the desired behavior in plain English — iterating in the terminal like a conversation.

It's a practical example of what's possible when you use Claude Code as a co-developer: going from idea to working pipeline in a single session, without context-switching out of the terminal.
